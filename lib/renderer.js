...
// NOTE: puppeteer-core and @sparticuz/chromium are loaded via dynamic import()
// inside openBrowser() so that webpack never attempts to bundle them at build time.
// next.config.js must list them in serverExternalPackages as well.
...
export async function openBrowser() {
  ...
  try {
    ...
    return null; // puppeteer-core not available at all
  }
