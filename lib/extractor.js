...
export const MAIN_CONTENT_SELECTORS = [
  ...
  // Extended CMS / builder selectors
  { sel: '.blog-detail',            method: 'cms-blog-detail',     conf: 0.80 },
  { sel: '.blog-details',           method: 'cms-blog-details',    conf: 0.80 },
  { sel: '.post-entry',             method: 'cms-post-entry',      conf: 0.78 },
  { sel: '.entry',                  method: 'cms-entry',           conf: 0.72 },
  { sel: '.content',                method: 'cms-content',         conf: 0.65 },
  { sel: '#primary',                method: 'id-primary',          conf: 0.65 },
  { sel: '.elementor-widget-container', method: 'elementor',       conf: 0.70 },
  { sel: '.td-post-content',        method: 'td-post-content',     conf: 0.82 },
  { sel: '.the-content',            method: 'the-content',         conf: 0.78 },
  { sel: '.content-area',           method: 'content-area',        conf: 0.68 },
  { sel: '.wp-block-post-content',  method: 'wp-block-post',       conf: 0.85 },
  // Fallback
  { sel: 'body',                    method: 'density-detected-body', conf: 0.45 },
];
...
export function extractMainContent($, {
  ...
  if (!zone) {
    zone = $('body'); method = 'density-detected-body'; confidence = 0.35;
  }
